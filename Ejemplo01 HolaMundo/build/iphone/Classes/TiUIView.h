...
/**
 Base class for all Ejemplo01HolaMundo views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Ejemplo01HolaMundo view hierarchy (such as wrapped iOS UIViews) was touched.
