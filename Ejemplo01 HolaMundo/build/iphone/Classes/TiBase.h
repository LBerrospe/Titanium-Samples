...
// in simulator we redefine to format for Ejemplo01HolaMundo Developer console
...
{\
	NSString * exceptionName = [@"org.ejemplo01holamundo." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ejemplo01holamundo";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIEjemplo01HolaMundoNativeItemNone = -1, 
	UIEjemplo01HolaMundoNativeItemSpinner = -2,
	UIEjemplo01HolaMundoNativeItemProgressBar = -3,
	
	UIEjemplo01HolaMundoNativeItemSlider = -4,
	UIEjemplo01HolaMundoNativeItemSwitch = -5,
	UIEjemplo01HolaMundoNativeItemMultiButton = -6,
	UIEjemplo01HolaMundoNativeItemSegmented = -7,
	
	UIEjemplo01HolaMundoNativeItemTextView = -8,
	UIEjemplo01HolaMundoNativeItemTextField = -9,
	UIEjemplo01HolaMundoNativeItemSearchBar = -10,
	
	UIEjemplo01HolaMundoNativeItemPicker = -11,
	UIEjemplo01HolaMundoNativeItemDatePicker = -12,
	
	UIEjemplo01HolaMundoNativeItemInfoLight = -13,
	UIEjemplo01HolaMundoNativeItemInfoDark = -14,
	
	UIEjemplo01HolaMundoNativeItemDisclosure = -15,
	
	UIEjemplo01HolaMundoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Ejemplo01HolaMundo instances of
