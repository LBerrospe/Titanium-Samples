...
//Rare exceptions to indicate a bug in the _ejemplo01holamundo code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Ejemplo01HolaMundo proxies.
 */
