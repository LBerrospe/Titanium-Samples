...
/**
 The base class for all Ejemplo01HolaMundo modules
 */
...
/**
 Ejemplo01HolaMundo Platform calls this method on startup.
 */
-(void)startup;

/**
 Ejemplo01HolaMundo Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Ejemplo01HolaMundo Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Ejemplo01HolaMundo Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Ejemplo01HolaMundo Platform calls this method on resume.
 @param sender The sender of the event.
 */
