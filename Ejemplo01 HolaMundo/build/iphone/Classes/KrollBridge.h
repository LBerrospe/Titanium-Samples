...
@interface Ejemplo01HolaMundoObject : KrollCoverageObject {
#else
@interface Ejemplo01HolaMundoObject : KrollObject {
#endif
@private
...
extern NSString * Ejemplo01HolaMundo$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Ejemplo01HolaMundoObject *_ejemplo01holamundo;
    KrollObject* console;
	BOOL shutdown;
