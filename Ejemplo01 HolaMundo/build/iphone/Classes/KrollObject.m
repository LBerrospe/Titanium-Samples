...
//@interface Ejemplo01HolaMundoObject : NSObject
//@end

@interface Ejemplo01HolaMundoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Ejemplo01HolaMundoObject class]])
		{
			for (NSString *key in [[(Ejemplo01HolaMundoObject*)o modules] allKeys])
			{
