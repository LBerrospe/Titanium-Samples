...
- (NSString*)userAgent
{
	if (userAgent==nil)
	{
		...
		NSString *kEjemplo01HolaMundoUserAgentPrefix = [NSString stringWithFormat:@"%s%s%s %s%s","Appc","eler","ator","Tita","nium"];
		userAgent = [[NSString stringWithFormat:@"%@/%s (%@)",kEjemplo01HolaMundoUserAgentPrefix,TI_VERSION_STR,currentDeviceInfo] retain];
	}
	return userAgent;
}
