...
/**
 The base class for all Ejemplo03TableView modules
 */
...
/**
 Ejemplo03TableView Platform calls this method on startup.
 */
-(void)startup;

/**
 Ejemplo03TableView Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Ejemplo03TableView Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Ejemplo03TableView Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Ejemplo03TableView Platform calls this method on resume.
 @param sender The sender of the event.
 */
