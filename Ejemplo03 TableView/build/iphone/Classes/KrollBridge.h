...
@interface Ejemplo03TableViewObject : KrollCoverageObject {
#else
@interface Ejemplo03TableViewObject : KrollObject {
#endif
@private
...
extern NSString * Ejemplo03TableView$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Ejemplo03TableViewObject *_ejemplo03tableview;
    KrollObject* console;
	BOOL shutdown;
