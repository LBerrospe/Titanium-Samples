...
/**
 Base class for all Ejemplo03TableView views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Ejemplo03TableView view hierarchy (such as wrapped iOS UIViews) was touched.
