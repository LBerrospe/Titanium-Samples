...
- (NSString*)userAgent
{
	if (userAgent==nil)
	{
		...
		NSString *kEjemplo03TableViewUserAgentPrefix = [NSString stringWithFormat:@"%s%s%s %s%s","Appc","eler","ator","Tita","nium"];
		userAgent = [[NSString stringWithFormat:@"%@/%s (%@)",kEjemplo03TableViewUserAgentPrefix,TI_VERSION_STR,currentDeviceInfo] retain];
	}
	return userAgent;
}
