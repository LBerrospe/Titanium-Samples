...
//Rare exceptions to indicate a bug in the _ejemplo03tableview code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Ejemplo03TableView proxies.
 */
