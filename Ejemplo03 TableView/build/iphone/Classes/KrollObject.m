...
//@interface Ejemplo03TableViewObject : NSObject
//@end

@interface Ejemplo03TableViewObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Ejemplo03TableViewObject class]])
		{
			for (NSString *key in [[(Ejemplo03TableViewObject*)o modules] allKeys])
			{
