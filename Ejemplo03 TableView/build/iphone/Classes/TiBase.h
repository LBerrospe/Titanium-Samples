...
// in simulator we redefine to format for Ejemplo03TableView Developer console
...
{\
	NSString * exceptionName = [@"org.ejemplo03tableview." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.ejemplo03tableview";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIEjemplo03TableViewNativeItemNone = -1, 
	UIEjemplo03TableViewNativeItemSpinner = -2,
	UIEjemplo03TableViewNativeItemProgressBar = -3,
	
	UIEjemplo03TableViewNativeItemSlider = -4,
	UIEjemplo03TableViewNativeItemSwitch = -5,
	UIEjemplo03TableViewNativeItemMultiButton = -6,
	UIEjemplo03TableViewNativeItemSegmented = -7,
	
	UIEjemplo03TableViewNativeItemTextView = -8,
	UIEjemplo03TableViewNativeItemTextField = -9,
	UIEjemplo03TableViewNativeItemSearchBar = -10,
	
	UIEjemplo03TableViewNativeItemPicker = -11,
	UIEjemplo03TableViewNativeItemDatePicker = -12,
	
	UIEjemplo03TableViewNativeItemInfoLight = -13,
	UIEjemplo03TableViewNativeItemInfoDark = -14,
	
	UIEjemplo03TableViewNativeItemDisclosure = -15,
	
	UIEjemplo03TableViewNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Ejemplo03TableView instances of
